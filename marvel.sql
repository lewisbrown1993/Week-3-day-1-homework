...
/*    
      ...
      Question 1: select * from movies;

      Question 2: update people set name = 'Kim North' where name = 'Km North';

      Question 3: select name from people where name = 'Lewis Brown';

      Question 4:  delete from movies where title = 'Batman Begins';

      Question 5: insert into people (name) values ('Keith Douglas');

      Question 6: delete from people where name = 'Craig Morton';

      Question 7: update people set name = 'Jeff 4' where id = 10;
                  update people set name = 'Jeff 5' where id = 11;

      Question 8: insert into movies (title, year, show_time) values ('Guardians of the Galaxy 2', 2017, '00:00');

      Question 9: update movies set show_time = '21:30' where title = 'Guardians of the Galaxy';
